 ...
 * They can interact with the database indirectly by calling queries and mutations using the `ActionCtx` object.
 *
 ...
 *
 * The two entry points are `db.get`, which fetches a single document by its `Id`, or
 * `db.query`, which starts building a query.
 */
